...
// It seems the only way to do this is by exhaustive again. So we count up and
// look for the first success. However, we don't have to check for all the
// divisors - if something is divisible by 20, it is also divisible by 10 and
// 5 and 4 and 2 ...
